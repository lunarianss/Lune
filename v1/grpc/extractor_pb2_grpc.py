...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                request_serializer=extractor__pb2.HelloRequest.SerializeToString,
                response_deserializer=extractor__pb2.HelloReply.FromString,
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=extractor__pb2.HelloRequest.FromString,
                    response_serializer=extractor__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/helloworld.Greeter/SayHello',
            extractor__pb2.HelloRequest.SerializeToString,
            extractor__pb2.HelloReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
